...
public class TestimoniAdapter extends ArrayAdapter<String> {
    ...
    public TestimoniAdapter(Activity context,
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView= inflater.inflate(R.layout.testimoni_list, null, true);
